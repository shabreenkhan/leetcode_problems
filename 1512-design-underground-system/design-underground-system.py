class UndergroundSystem:
    ...
    def checkIn(self, id: int, stationName: str, t: int) -> None:
        self.customer[id] = (stationName,t)  #key-id,value->(stationame,t)

    def checkOut(self, id: int, stationName: str, t: int) -> None:
         #pop out the customer from customers map since the ride/trip is over
         startStation,startTime = self.customer.pop(id)
         trip = startStation,stationName   #stationName here is end stationm it's cout
